...
public class ChooseOne extends AppCompatActivity {
    ...
    Button Publisher,Customer,DeliveryPerson;
    Intent intent;
    String type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animationDrawable.addFrame(getResources().getDrawable(R.drawable.img0),3000);
        ...
        Publisher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(type.equals("Email")){
                    Intent loginemail  = new Intent(ChooseOne.this,Publisherlogin.class);
                    startActivity(loginemail);
                    finish();
                }
                if(type.equals("Phone")){
                    Intent loginphone  = new Intent(ChooseOne.this,Publisherloginphone.class);
                    startActivity(loginphone);
                    finish();
                }
                if(type.equals("SignUp")){
                    Intent Register  = new Intent(ChooseOne.this,PublisherRegistration.class);
